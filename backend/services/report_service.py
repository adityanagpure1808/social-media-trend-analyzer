...
#             raise Exception(tavily.get("error", "Tavily API failed"))
...
#             # ❗ Never fail report due to embeddings
#             print("⚠️ Embeddings failed:", embed_error)
...
# # from Backend.services.vector_db import get_vector_collection
...
#         # =========================
#         # STEP 6 — EMBEDDINGS (NON-FATAL — SAME BEHAVIOUR AS OLD CODE)
#         # =========================
#         try:
...
#             # intentional non-fatal behavior
...
# #             print("✅ EMBEDDINGS STORED FOR:", report_id)

# #         except Exception as embed_error:
# #             # ❗ Never fail report due to embeddings
# #             print("❌ EMBEDDINGS FAILED:", embed_error)
...
# # temprory debug function to dump vector db info
# def debug_vector_dump():
#     collection = get_vector_collection()
#     print("🧠 TOTAL VECTORS IN DB:", collection.count())

#     # Print first 3 metadatas
